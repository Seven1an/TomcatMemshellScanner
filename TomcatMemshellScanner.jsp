...
<center>
        ...
        <%!
            ...
            public static String judgeClassLocation(Class<?> clazz) {
                try {
                    ...
                    if (url == null) {
                        return "<span style='color:orange;'>磁盘无 class 文件：可能是内存马</span>";
                    }

                    String urlStr = url.toString();

                    if (urlStr.contains("/work/") || urlStr.contains(File.separator + "work" + File.separator)) {
                        return "<span style='color:orange;'>class 来自 work 目录：可能是内存马</span>";
                    }
                    ...
                    if (urlStr.contains(".jar!")) {
                        ...
                        String formattedTime = new SimpleDateFormat("yyyy年M月d日HH:mm:ss").format(new Date(time));
                        return "class来自核心类或依赖库，最后修改时间 " + formattedTime;
                    }

                    if (urlStr.contains("/WEB-INF/classes/") || urlStr.contains(File.separator + "WEB-INF" + File.separator + "classes" + File.separator)) {
                        return "class来自部署目录：问题不大";
                    }
        ...
        <%
            ...
            if (action != null && action.equals("kill") && filterName != null) {
                ...
                try {
                    ...
                    out.write("<div style='color:darkred; font-weight:bold;'>配合使用 arthas 进行反编译</div>");
                    out.write("<div>项目地址：<a href='https://github.com/alibaba/arthas' target='_blank'>https://github.com/alibaba/arthas</a></div>");
                ...
                out.write("<h4>Tomcat-Valve scan result</h4>");
    ...
    <br/>
    项目地址：<a href="https://github.com/Seven1an/TomcatMemshellScanner" target="_blank" style="color:#888;">https://github.com/Seven1an/TomcatMemshellScanner</a>
</center>
</body>
</html>
